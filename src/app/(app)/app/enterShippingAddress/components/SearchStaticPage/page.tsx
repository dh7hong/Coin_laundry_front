...
const SearchStaticPage: FC<SearchStaticPageProps> = ({ handleActivate }) => {
  ...
  const handleBackNavigation = () => {
    ...
    router.push("/app/enterShippingAddress/inputAddress/C-searchToggle"); // Navigate to the previous page
  };
  ...
  const handleSave = () => {
    ...
    router.push("/app/enterShippingAddress/inputAddress/E-addAddressEntryMethod");
  };
