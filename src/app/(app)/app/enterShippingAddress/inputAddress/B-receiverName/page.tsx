...
const ReceiverName: FC = () => {
  ...
  const handleBackNavigation = () => {
    router.push("/app/enterShippingAddress/inputAddress/A-shippingName"); // Navigate to the previous page
  };
  ...
  const handleNextPageNavigation = () => {
    router.push("/app/enterShippingAddress/inputAddress/C-searchToggle"); // Navigate to the C-searchToggle page
  };
  ...
  return (
    <div className="flex justify-center items-center bg-gray-50">
      <div className="w-[390px] bg-white flex flex-col justify-center items-center">
        ...
        {isButtonGray ? (
          <ActionButtonGray label={`다음`} onClick={handleForwardNavigation} />
        ) : (
