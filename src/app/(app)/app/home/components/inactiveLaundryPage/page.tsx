...
const InactiveLaundryPage = () => {
	...
	return (
		<div className="relative p-3 bg-white w-[290px] h-auto rounded-md border mx-auto">
			{/* Top Section */}
			...
			{/* Overlay */}
			<div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col items-center justify-center rounded-md backdrop-blur-sm">
				<LockIcon className="w-7 h-7 text-white" />
				<div className=" text-white mt-[12px]  mb-[12px] text-center whitespace-pre-line ">
					배송지를 입력하시면{"\n"}보여요!
				</div>
				<div></div>
				<CTAButtonSmall
					...
					onClick={handleSetInfo} // Add onClick handler here
				/>
			</div>
		</div>
	);
...
export default InactiveLaundryPage;
