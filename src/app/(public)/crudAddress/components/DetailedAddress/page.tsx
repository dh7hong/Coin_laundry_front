// src/app/crudAddress/components/DetailedAddress/page.tsx
"use client";
...
const DetailedAddress: FC = () => {
    ...
    const { shippingName, receiverName, selectedAddress, detailedAddress } = address;
    ...
    const handleDetailedAddressChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        setAddress(prev => ({ ...prev, detailedAddress: e.target.value }));
    };
