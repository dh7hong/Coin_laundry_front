...
const EnterPlaceholder = forwardRef<HTMLInputElement, EnterPlaceholderProps>((props, ref) => (
  ...
  <div className={`flex items-center border rounded-md w-full max-w-[430px] h-[48px] px-[16px] py-[12px] text-body-2-normal`}>
    
    <input
      id={props.id}
      placeholder={props.placeholder}
      ref={ref} // Forward the ref to the input element
      className="bg-transparent text-body-2-normal text-label-normal font-normal w-full outline-none" // Add your desired class
    />
  </div>
));
